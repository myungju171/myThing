...
.http-request
include::{snippets}/친구_삭제_성공/http-request.adoc[]

.request-headers
include::{snippets}/친구_삭제_성공/request-headers.adoc[]

.path-parameters
include::{snippets}/친구_삭제_성공/path-parameters.adoc[]

.http-response
include::{snippets}/친구_삭제_성공/http-response.adoc[]
