...
=== 핸드폰_번호로_유저_조회시_성공
.http-request
include::{snippets}/핸드폰_번호로_유저_조회시_성공/http-request.adoc[]

.Request-parameters
include::{snippets}/핸드폰_번호로_유저_조회시_성공/request-parameters.adoc[]

.http-response
include::{snippets}/핸드폰_번호로_유저_조회시_성공/http-response.adoc[]

.response-fields
include::{snippets}/핸드폰_번호로_유저_조회시_성공/response-fields.adoc[]
...
***
== 아이템 리스트 조회
=== 본인의_아이템_리스트_조회_성공_200

.http-request
include::{snippets}/본인의_아이템_리스트_조회_성공_200/http-request.adoc[]

.Path parameters
include::{snippets}/본인의_아이템_리스트_조회_성공_200/path-parameters.adoc[]

.Request parameters
include::{snippets}/본인의_아이템_리스트_조회_성공_200/request-parameters.adoc[]

.http-response
include::{snippets}/본인의_아이템_리스트_조회_성공_200/http-response.adoc[]

.response-fields
include::{snippets}/본인의_아이템_리스트_조회_성공_200/response-fields.adoc[]

=== 친구의_아이템_리스트_조회_성공_200

.http-request
include::{snippets}/친구의_아이템_리스트_조회_성공_200/http-request.adoc[]

.Path parameters
include::{snippets}/친구의_아이템_리스트_조회_성공_200/path-parameters.adoc[]

.Request parameters
include::{snippets}/친구의_아이템_리스트_조회_성공_200/request-parameters.adoc[]

.http-response
include::{snippets}/친구의_아이템_리스트_조회_성공_200/http-response.adoc[]

.response-fields
include::{snippets}/친구의_아이템_리스트_조회_성공_200/response-fields.adoc[]
