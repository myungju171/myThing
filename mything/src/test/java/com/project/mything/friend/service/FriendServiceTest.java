...
//                .image(ImageTest.builder().id(1L).remotePath("remotePath").build())
//                .build();
...
//        given(friendMapper.toResponseSimpleFriend(any(), any())).willReturn(responseSimpleFriend);
//        //when
...
//        assertThat(result.getAvatarId()).isEqualTo(dbUser.getImage().getId());
//        assertThat(result.getRemotePath()).isEqualTo(dbUser.getImage().getRemotePath());
//    }
//
//    @Test
